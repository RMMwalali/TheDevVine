...
const Sidebar = ({ posts, categories, className }) => {
  ...
  return (
    <aside className={`${className} px-0 lg:px-6 lg:col-4`}>
      {about.enable && (
        <div className="relative rounded border-2 border-black border-border p-6 text-center dark:border-darkmode-border">
          <ImageFallback
            className="-z-[1]"
            src="/images/map.svg"
            fill={true}
      ...
      {/* newsletter */}
      {newsletter.enable && (
        <div className="mt-6  rounded border-2 border-black border-border p-6 text-center dark:border-darkmode-border">
