      ...
      <section className="section banner relative pb-0">
        ...
        <div className="container">
          <div className="row flex-wrap-reverse items-center justify-center lg:flex-row">
            <div className={banner.image_enable ? "mt-8 text-center lg:mt-0 lg:text-left lg:col-6" : "mt-8 text-center lg:mt-0 lg:text-left lg:col-12"}>
            ...
            <div className="mb-12 lg:mb-0 lg:col-8">
              ...
              {/* {featured_posts.enable && (
                <div className="section">
                  ...
                  <div className="rounded border-border p-6 dark:border-darkmode-border">
                    <div className="row">
              ...
              {recent_posts.enable && (
                <div className="section pt-0">
                  ...
                  <div className="rounded border border-darkmode-border px-6 pt-6 dark:border-darkmode-border">
                    <div className="row">
